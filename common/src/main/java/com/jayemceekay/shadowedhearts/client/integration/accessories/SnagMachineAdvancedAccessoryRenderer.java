...
public class SnagMachineAdvancedAccessoryRenderer implements AccessoryRenderer {

    private SnagMachineAdvancedModel<LivingEntity> model;
    ...
    public <M extends LivingEntity> void render(
        ...
        if (this.model == null) {
            this.model = new SnagMachineAdvancedModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(SnagMachineAdvancedModel.LAYER_LOCATION));
        }
        ...
        matrices.translate(0.19F, -0.1250F, 0.0F);
